...
//        this.formularioPersona.setBounds(0, 0, 1000, 700);
//        this.Escuchadores();
//
//    }
//
...
//
//            if (formularioPersona.txtNombre.getText().isEmpty()
//                    || formularioPersona.txtApellidoPaterno.getText().isEmpty()
//                    || formularioPersona.txtApellidoMaterno.getText().isEmpty()
//                    || formularioPersona.txtDireccion.getText().isEmpty()
//                    || formularioPersona.txtNumeroDocumento.getText().isEmpty()
//                    || formularioPersona.txtNacionalidad.getText().isEmpty()
//                    || formularioPersona.txtReferencia.getText().isEmpty()) {
//
...
//                per.setIdTipoDoc(new Tipodocumento(Integer.parseInt(formularioPersona.txtIdTipoDocumento.getText().trim()), ""));
//                per.setNumerodoc(formularioPersona.txtNumeroDocumento.getText().trim());
//                if (formularioPersona.txtTelefono.getText().isEmpty()) {
//                    per.setTelefono("Falta ingresar datos");
//                } else {
//                    per.setTelefono(formularioPersona.txtTelefono.getText().trim());
//                }
//                per.setDireccion(formularioPersona.txtDireccion.getText().trim());
//                if (formularioPersona.txtCorreo.getText().isEmpty()) {
//                    per.setCorreo("Falta ingresar datos");
//                } else {
...
//
//        }
//        if (ae.getActionCommand().equals("Limpiar Campos")) {
//            limpiar();
//            listarTDocumentos();
//            listarPersonas();
//            formularioPersona.btnGuardar.setText("Guardar");
...
//            JOptionPane.showMessageDialog(null, "Coloque solo el NOMBRE del CLIENTE", "Advertencia", JOptionPane.ERROR_MESSAGE);
//        }
//
//    }
//
...
//            formularioPersona.txtIdTipoDocumento.setText(Integer.toString(tp.getIdTipoDoc()));
//        }
//    }
//}
