...
public class CtrlMain implements ActionListener{
    ...
    public CtrlMain(Main form, int idEmp) {

        this.formMain = form;        
        
        ScreenHabitaciones formHab = new ScreenHabitaciones();
        //CtrlScreenHabitaciones ctrlScreenHab = new CtrlScreenHabitaciones(formHab,formMain.DskMain, idEmp);        
    ...
    private void addTabPanel(){
        ...
        JButton btnRegHabitacion = new JButton("Mantenimiento Habitaciones");
